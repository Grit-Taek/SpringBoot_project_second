...
class PersonControllerTest {
    ...
    void modifyPerson() throws Exception {
        ...
        PersonDto personDto = PersonDto.of("martin" , "programming" , "판교", LocalDate.now(), "programmer","010-1111-1111");
    ...
    void modifyPersonIfNameIsDifferent() throws Exception {
        ...
        PersonDto personDto = PersonDto.of("james" , "programming" , "판교", LocalDate.now(), "programmer","010-1111-1111");
